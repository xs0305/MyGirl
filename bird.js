        ...
        if(flying){
            ...
            if(birds.y<=0){//判断小鸟是否撞到顶
                ...
                co.style.display="none";
					document.getElementById('overMsg').innerHTML="SoSo凉了......";
    ...
    function createzz(x){//初始化柱子属性
        ...
        setInterval(function(){//控制柱子移动
            ...
            var dcheck=birds.x + 30 > zz.x && birds.x < zz.x + 52 && birds.y+30 >= zz.uheight + 110;
            if(ucheck || dcheck){
                flying=false;
                mask.style.display="block";
                success.style.display="block";
